  ...
  return (
    <>
      <Head>
        ...
        <link href="https://fonts.googleapis.com/css2?family=Sora:wght@400;600;700;800&family=Inter:wght@400;500;600&family=IBM+Plex+Mono:wght@500&display=swap" rel="stylesheet" />
      </Head>
      ...
      <style jsx global>{`
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .glow-1 {
          ...
          top: -160px; left: -120px; opacity: 0.5; filter: blur(80px); z-index: 0;
        }
        .glow-2 {
          position: fixed; width: 520px; height: 520px; border-radius: 50%;
          background: radial-gradient(circle, #0e7490, transparent 68%);
          bottom: -160px; right: -120px; opacity: 0.35; filter: blur(80px); z-index: 0;
        }
        .card {
          position: relative; z-index: 1; background: #111a2e;
          border: 1px solid rgba(120,150,210,0.16); border-radius: 20px;
        ...
        .subhead { font-size: 14.5px; color: #9aa8c4; margin-bottom: 32px; }
        .field { margin-bottom: 18px; }
        .field label {
          display: block; font-family: "IBM Plex Mono", monospace;
          font-size: 11.5px; letter-spacing: 0.1em; text-transform: uppercase;
          color: #6b7a99; margin-bottom: 8px;
        }
        .field input {
          width: 100%; background: #0d1424;
          border: 1px solid rgba(120,150,210,0.2); border-radius: 10px;
          padding: 13px 16px; font-size: 15px; color: #eef2fb;
        ...
        .btn {
          ...
          cursor: pointer; transition: opacity 0.2s, transform 0.18s; margin-top: 8px;
        }
        .btn:hover { opacity: 0.92; transform: translateY(-1px); }
        .btn:disabled { opacity: 0.5; cursor: not-allowed; transform: none; }
        .divider { height: 1px; background: rgba(120,150,210,0.14); margin: 28px 0; }
        .footer-text { text-align: center; font-size: 13.5px; color: #6b7a99; }
      ...
      <div className="card">
        ...
        <div className="footer-text">
          Need access? <a href="mailto:info@arvenix.io">Contact your Arvenix rep</a>
        </div>
      </div>
    </>
  );
